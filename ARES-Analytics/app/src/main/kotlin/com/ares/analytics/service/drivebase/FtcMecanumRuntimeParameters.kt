...
internal object FtcMecanumRuntimeParameters {
    ...
    private fun common(
        ...
        double("ftc.drive.feedforward.ks", "drive.feedforwardKs", "Drive static feedforward", "Simulation baseline in fractions of 12 V; divide measured static-friction voltage by 12 before physical use.", 0.0, "normalized", 0.0, 1.0, TuningApplyPolicy.DISABLED_ONLY),
        double("ftc.drive.feedforward.kv", "drive.feedforwardKv", "Drive velocity feedforward", "Simulation baseline for 1 m/s in fractions of 12 V per m/s; divide voltage-based characterization gains by 12 before physical deployment.", 1.0, "normalized/(m/s)", 0.000001, 20.0, TuningApplyPolicy.DISABLED_ONLY),
        double("ftc.drive.feedforward.ka", "drive.feedforwardKa", "Drive acceleration feedforward", "Simulation baseline in fractions of 12 V per m/s^2; divide voltage-based characterization gains by 12 before physical deployment.", 0.0, "normalized/(m/s^2)", 0.0, 20.0, TuningApplyPolicy.DISABLED_ONLY),

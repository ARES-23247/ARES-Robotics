    ...
    companion object {
        ...
        val OFFICIAL_PROJECT_TEMPLATES: List<RobotProjectTemplate> = listOf(
            RobotProjectTemplate(
                id = "ares-ftc-starter-13.0.0",
                displayName = "ARES FTC Starter",
                league = League.FTC,
                aresVersion = "13.0.0",
                revision = "schema4-standalone-v1",
                archiveUrl = "https://github.com/ARES-23247/ARES-Robotics/releases/download/v3.1.1/ARES-FTC-Starter-13.0.0.zip",
                archiveSha256 = "1b9ddf40e4a49d3fd2745c23f2075ef4e4312c0b8ffc5f6c32532c6b0a6d88ff",
                bundledResourcePath = "/project-templates/ARES-FTC-Starter-13.0.0.zip",
                deploymentPolicy = RobotProjectDeploymentPolicy.HARDWARE_REVIEW_REQUIRED,
            ),
            RobotProjectTemplate(
                id = "ares-frc-starter-13.0.0",
                displayName = "ARES FRC Starter",
                league = League.FRC,
                aresVersion = "13.0.0",
                revision = "schema4-standalone-v1",
                archiveUrl = "https://github.com/ARES-23247/ARES-Robotics/releases/download/v3.1.1/ARES-FRC-Starter-13.0.0.zip",
                archiveSha256 = "3922a72cccfbe7cc7cbba92489df2c0f5268026572d686a0c2752f865a4bf1be",
                bundledResourcePath = "/project-templates/ARES-FRC-Starter-13.0.0.zip",
                deploymentPolicy = RobotProjectDeploymentPolicy.HARDWARE_REVIEW_REQUIRED,
            ),
        )

# Code-first and hybrid FRC projects

This repository is standalone. After ARES Robotics Studio creates it, Studio may be closed and the
project can be built, tested, simulated, and deployed from WPILib VS Code, IntelliJ IDEA, or a
terminal. Normal FRC simulation and deployment continue to use GradleRIO and WPILib HAL.
...
- `CODE_FIRST`: Kotlin under `org.aresfirst.starter.frc.extensions` is authoritative.
...
```powershell
.\gradlew.bat verifyAresProject test

...
import com.areslib.frc.config.CanonicalDrivebaseConfig
...
internal object FrcSeasonHardwareFactory {
    ...
    private fun createReal(fieldContract: FrcFieldContract?, canBus: CANBus): FrcSeasonHardware {
        ...
        val activeOffsets = SwerveOffsetManager.loadOffsets(
            defaultOffsets = defaultOffsets,
            typedTuningOffsets = CanonicalDrivebaseConfig.profiledOffsets(),
        )

...
dependencies {
    ...
    implementation("org.lwjgl:lwjgl-glfw:3.4.3")
...
dependencies {
    ...
    add(hostRuntime.name, "org.lwjgl:lwjgl:3.4.3:$hostLwjglClassifier")
    add(hostRuntime.name, "org.lwjgl:lwjgl-glfw:3.4.3:$hostLwjglClassifier")
}
